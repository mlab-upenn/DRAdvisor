function varargout = Inputs_modified(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Inputs_modified_OpeningFcn, ...
                   'gui_OutputFcn',  @Inputs_modified_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Inputs_modified is made visible.
function Inputs_modified_OpeningFcn(hObject, eventdata, handles, varargin)
handles.output = hObject;
guidata(hObject, handles);

% --- Outputs from this function are returned to the command line.
function varargout = Inputs_modified_OutputFcn(hObject, eventdata, handles) 
